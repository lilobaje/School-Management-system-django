...
from school_management_app import adminviews, StaffViews,StudentViews, views,forms,EditResultVIewClass
from school_management_app.EditResultVIewClass import EditResultViewClass
urlpatterns = [
    path('admin/', admin.site.urls),
    path('demopage',views.Demopage),
    path('accounts/',include('django.contrib.auth.urls')),
    path('',views.Logindon,name="Logindon"),
    path('dologin',views.doLogin,name="do_login"),
    path('get_user_details', views.GetUserDetails),
    path('logout_user', views.logout_user,name="logout"),
    path('admin_home',adminviews.AdminHome, name="admin_home"),
